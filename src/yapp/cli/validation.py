...
pipeline_schema = {
    "inputs": {"type": "list", "schema": {
        "allow_unknown": True, "type": ["string", "dict"], "check_with": check_adapter
        }},
    "expose": {"type": "list", "schema": {"type": "dict", "check_with": check_expose}},
    "steps": {
        "type": "list", "schema" : {
            "type": ["dict", "string"], "check_with": check_step,
            }
        },
    "outputs": {"type": "list", "schema": {
        "allow_unknown": True, "type": ["string", "dict"], "check_with": check_adapter
        }},
    "hooks": {
        "schema": {hook: {"type": "list", "schema":
            {
